<head>
    ...
    <div class="content">
        <div class="row">
            <!-- Nama SOP -->
            <div class="col-md-12">
                <?php echo form_open_multipart('admin/sop_edit');?>
                <?php foreach ($GetSopSpes as $g) { ?>                
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"> ID SOP</h4>
                    </div>
                    <div class="card-body">
                        <!-- <div class="table-responsive"> -->
                        
                        <div class="form-group">
                            <input type="text" class="form-control" value="<?php echo $g->idsop; ?>" placeholder="id-sop"  required="" name="idsop" readonly/>
                        </div>
                        <!-- </div> -->
                    </div>
                    <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" value="<?php echo $g->namasop; ?>" placeholder="nama-sop"  required="" name="namasop"/>
                        </div>
                        <!-- </div> -->
                    </div>
                </div>
